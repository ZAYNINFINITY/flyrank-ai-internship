# Week 5 — Submission Checklist (Portal Copy-Paste)
...
**Attach:** `week-05/task-1-museum-spatial-system.md`
**Screenshots:** none
**Live:** https://foyer-cyan.vercel.app/entrance
**Repo links:**
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-05/task-1-museum-spatial-system.md
...
**Attach:** `week-05/task-2-phase-a-ai-communication-layer.md`
**Screenshots:** none
**Live:** https://foyer-cyan.vercel.app/assistant
**Repo links:**
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-05/task-2-phase-a-ai-communication-layer.md
...
**Attach:** `week-05/fe-07-tool-results.md` + `week-05/fe-07-sse-tool-call.txt`
**Screenshots:**
...
**Attach:** `week-05/phase-c-cohesive-wiring.md`
**Screenshots (7):**
...
| 6 | Ship the Ugly One | `ship-the-ugly-one.md` | — | foyer |

# Week 6 — Submission Checklist (Portal Copy-Paste)
...
**Attach (MD):**
- `week-6-submission-summary.md`
- `week-6-audit-findings.md`

**Screenshots (IMG):**
- `fe-aa1-motion-idle.png`
- `fe-aa1-motion-loading.png`
- `fe-aa1-motion-success.png`
- `fe-aa1-motion-error.png`

**LINK:** https://foyer-cyan.vercel.app/playground/motion-lab
...
**Attach (MD):**
- `fe-09-ci-evidence.md`

**Screenshots (IMG):**
- `week6-fe-09-ci-green.png`
...
**Attach (MD):**
- `phase-8-explain-it-like-you-built-it.md`

**Screenshots (IMG):** none

**LINK:** none (doc assignment)
...
|---|---|---|---|---|
| 1 | FE-AA1 Buttons with a Brain | `week-6-submission-summary.md` + `week-6-audit-findings.md` | 4 (`fe-aa1-motion-*`) | /playground/motion-lab |
| 2 | FE-09 Testing Pass | `fe-09-ci-evidence.md` | 1 (`week6-fe-09-ci-green.png`) | foyer-cyan.vercel.app |
| 3 | Explain It Like You Built It | `phase-8-explain-it-like-you-built-it.md` | — | N/A |

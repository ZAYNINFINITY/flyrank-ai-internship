...
**LINK:** https://foyer-cyan.vercel.app/explore
...
**LINK:** https://foyer-cyan.vercel.app/about
...
|---|---|---|---|---|
| 1 | FE-AA2 3D Experience | `week-7-submission-summary.md` + `fe-aa2-3d-room.md` + `fe-aa2-perf-note.md` | 4 (`fe-aa2-*`) | foyer-cyan.vercel.app |
| 2 | Break Your Own Site | `break-your-own-site.md` | 1 (`break-your-own-site-explore.png`) | /explore |
| 3 | Plant Your Flag | `plant-your-flag.md` | — | foyer-cyan.vercel.app |

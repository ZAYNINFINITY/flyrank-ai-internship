...
## Assignment 1 — FE-AA3 (Shader Hero)
...
## Assignment 2 — Plan to Keep Building
...
## Assignment 3 — FL-09 (README + Demo Video)

**Attach (MD):**
- `fl-09-demo-video.md`
- `week-03/app/README.md`
...
**Repo links:**
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-08/fl-09-demo-video.md
...
## Assignment 4 — FE-11 (Deploy + README)
...
**Repo links:**
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-08/plan-to-keep-building.md
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-08/send-the-link.md
...
**Attach (MD):**
- `build-in-public-post.md`
- `model-swap-report.md`
- `tree-plank-diagnostic-report.md`
- `week-8-submission-summary.md`
- `FINAL-SUBMISSION.md`

**Repo links:**
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-08/build-in-public-post.md
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-08/model-swap-report.md
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-08/tree-plank-diagnostic-report.md
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-08/week-8-submission-summary.md
- https://github.com/ZAYNINFINITY/flyrank-ai-internship/blob/main/week-08/FINAL-SUBMISSION.md
...
|---|---|---|---|---|---|---|
| 1 | FE-AA3 Shader | `fe-aa3-shader-hero.md` | — | — | — | plinth-cyan.vercel.app |
| 2 | Plan to Keep Building | `plan-to-keep-building.md` | — | — | — | Issue #17 |
| 3 | FL-09 README + Demo | `fl-09-demo-video.md` + README | MP4 (5m28s) + GIF (183KB) | — | — | plinth-cyan.vercel.app |
| 4 | FE-11 Deploy + README | `deployment-checklist.md` + `lighthouse-scores.md` | — | 4 JSONs | `test-results.png` | plinth-cyan.vercel.app |
| 5 | Ship It Capstone | `project-brief.md` + `capstone-final-report.md` + `reflection.md` | PDF (28MB) + MP4 + GIF | 4 JSONs | `test-results.png` | plinth-cyan.vercel.app |
| 6 | Send the Link Capstone | `plan-to-keep-building.md` + `send-the-link.md` | — | — | — | Issue #17 |
